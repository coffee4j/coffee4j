...
class IdentificationPhaseTest implements MockingTest {
    ...
    static void prepareMocks() {
        ...
        when(INTERLEAVING_COMBINATORIAL_TEST_MANAGER.initializeIdentification(failingCombinationInt, result))
    ...
    @Test
    void executePhase() {
        final IdentificationPhase phase = new IdentificationPhase(context);
        Combination combination = phase.initialize(failingCombination, result);
        ...
        combination = phase.reinitialize();
