...
class CombinatorialTestModelTest {
    ...
    void preconditions(int strength, int[] parameterSizes, List<TupleList> forbiddenTupleLists, List<TupleList> errorTupleLists, Class<? extends Exception> expected) {
        assertThrows(expected, () -> new CombinatorialTestModel(strength, parameterSizes, forbiddenTupleLists, errorTupleLists));
    }
    ...
    void constructModel() {
        ...
        final CombinatorialTestModel model = new CombinatorialTestModel(1, parameterSizes, forbiddenTupleLists, errorTupleLists);
    ...
    void defaultConstructors() {
        final List<TupleList> forbiddenTupleLists = Collections.singletonList(new TupleList(1, new int[]{0}, Collections.singletonList(new int[]{0})));
        final int[] parameterSizes = new int[]{2, 3};
        CombinatorialTestModel model = new CombinatorialTestModel(2, parameterSizes);
        ...
        model = new CombinatorialTestModel(2, parameterSizes, forbiddenTupleLists);
