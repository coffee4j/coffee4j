...
/**
 * An interface for classes which can convert an {@link InputParameterModel} to a {@link CompleteTestModel}.
...
public interface ModelConverter {
     ...
     * @param constraint the constraint to convert. Needs to be one in the original testModel, otherwise success of this
     *                   method is not guaranteed. Must not be {@code null}
     * @return the corresponding {@link MethodBasedConstraint} representation so that it matches the testModel conversion
     */
