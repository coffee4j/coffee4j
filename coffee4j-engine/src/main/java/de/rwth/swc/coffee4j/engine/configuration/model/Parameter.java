...
public final class Parameter {
    ...
    public static final class Builder {
        ...
        /**
         * Adds on new value to the parameter. The value will have the number of previous values as an id and the
         * given object as data.
         *
         * <p>If a {@link Value.Builder} is given as a parameter the value will be build from the builder.
         *
         * @param value the value object to be added. May be {@code null} as it will be wrapped in {@link Value}
         * @return this
         */
        public Builder value(Object value) {
            final int nextId = values.size();
            
            if (value instanceof Value.Builder) {
                final Value.Builder valueBuilder = (Value.Builder) value;
                values.add(valueBuilder.build(nextId));
            } else {
                values.add(new Value(nextId, value));
            }
