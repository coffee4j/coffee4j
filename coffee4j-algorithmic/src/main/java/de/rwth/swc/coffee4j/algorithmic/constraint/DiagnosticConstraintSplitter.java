...
/**
 * Splits the constraints of a {@link CompleteTestModel} into hard- and soft-constraints which is
...
class DiagnosticConstraintSplitter {
     ...
     */
    Pair<List<Constraint>, List<Constraint>> splitConstraints(CompleteTestModel testModel,
