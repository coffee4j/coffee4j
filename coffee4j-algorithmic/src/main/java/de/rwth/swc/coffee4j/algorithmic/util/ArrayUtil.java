...
public final class ArrayUtil {
     ...
     *
     * @param elements all elements which are searched. Must not be {@code null}
     * @param otherElements all elements which must appear in elements
     * @return whether the otherElements appear in the given elements at any arbitrary indices
     */
    public static boolean containsAll(int[] elements, int[] otherElements) {
        ...
        for(int otherElement : otherElements) {
            if(!contains(elements, otherElement)) {
                return false;
            }
        }
    ...
    /**
     *
     * @param elements all elements building the search space.
     * @param element element that needs to be found in the search space.
     * @return index of element in search space
     */
    ...
    /**
     *
     * @param elements elements that are checked for duplicates.
     * @return true iff elements contain duplicates.
     */
