...
class ConflictDetectionResultConverterTest {
    ...
    void testConvertConflictSet() {
        final CompleteTestModel expandedTestModel = mock(CompleteTestModel.class);
        when(expandedTestModel.getExclusionTupleLists()).thenReturn(Collections.emptyList());
    ...
    void testConvertInconsistentBackground() {
        final CompleteTestModel testModel = mock(CompleteTestModel.class);
