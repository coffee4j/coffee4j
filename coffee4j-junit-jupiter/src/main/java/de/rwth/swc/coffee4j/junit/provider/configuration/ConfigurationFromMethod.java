...
@ConfigurationSource(MethodBasedProvider.class)
public @interface ConfigurationFromMethod {
    
    /**
     * The name of the method from which a
     * {@link CombinatorialTestConsumerManagerConfiguration} can be loaded.
     * Consequently, the method defined by the value must either return a
     * {@link CombinatorialTestConsumerManagerConfiguration} directly, or a
     * {@link CombinatorialTestConsumerManagerConfiguration.Builder} which can be
